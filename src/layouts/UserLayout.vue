...
<style lang="less" scoped>
  #userLayout.user-layout-wrapper {
    ...
    .container {
      width: 100%;
      min-height: 100%;
      background: linear-gradient(to left, #CBB587, #A28A59) !important;
      background-size: 100%;
